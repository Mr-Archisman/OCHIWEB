...
import { awwwards, side } from "@/public";
								...
								<div className="flex items-center gap-[5px]">
									<motion.span
										...
										<Image
											...
											src={side}
											alt="img"
											className="w-auto h-[65px] lg:w-auto lg:h-auto md:w-[100px] md:h-[63px] sm:w-[74px] sm:h-[45px] xm:w-[64px] xm:h-[40px] object-cover xl:mt-[15px] mt-[10px] rounded-[10px]"
										/>
									</motion.span>
									<h1 className="heading tracking-[-1.3px] text-[#212121] font-semibold font-FoundersGrotesk uppercase">
										eye-opening
